...
export default function Home() {
  ...
  const handleChangeFilter = (e) => {
    ...
    const filterPodcast = podcastArr.filter(
      (podcast) =>
        podcast.title.label.includes(value) ||
        podcast.summary.label.includes(value)
    );
    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.search_results}>
          {podcastArrFiltered &&
            podcastArrFiltered.map((podcast) => {
              return (
                <Link
                ...
                >
                  ...
                  <div className={styles.search_item_title}>
                    {podcast.title.label}
                  </div>
                  <div className={styles.search_item_author}>
